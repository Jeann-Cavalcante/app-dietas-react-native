    ...
    <View className='flex-1 bg-primary'>
      <View className='flex  bg-primary h-44 flex-row items-center px-4 pt-10'>
        ...
        <View className='justify-center items-center pl-8'>
          <Text className='text-4xl font-bold text-center text-gray-700'>{list?.porc+'%'}</Text>
      ...
      <View className='rounded-t-3xl flex-1 px-4 pt-6 bg-gray-100 '>
        ...
        <View className='my-6'>
        <Card  cor={inside} porc={list?.bestSequence} text='melhor sequência dentro da dieta' />
        </View>
        <Card cor={inside} porc={list?.reg} text='refeições registradas' />

        <View className='flex-row w-full gap-x-4 mt-6 justify-between'>
          <View className='w-1/2'>
          <Card cor={inside} porc={list?.inside_in} text='dentro da dieta' />
          </View>
          <View className='w-1/2'>
          <Card cor={inside} porc={list?.inside_out} text='fora da dieta' />
